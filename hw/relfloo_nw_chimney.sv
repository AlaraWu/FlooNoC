...
module relfloo_nw_chimney #(
  ...
  `FLOO_TYPEDEF_NW_AXI_TYPES(axi_narrow, axi_wide, AxiCfgN, AxiCfgW)
  `FLOO_TYPEDEF_NW_CHAN_ALL(axi, req, rsp, wide, axi_narrow, axi_wide, AxiCfgN, AxiCfgW, hdr_t)
  `FLOO_TYPEDEF_REL_NW_CHAN_ALL(axi, req, rsp, wide, axi_narrow, axi_wide, AxiCfgN, AxiCfgW, hdr_t)
  ...
  // Flit encoding/decoding
  logic floo_req_ready_pre_enc, floo_rsp_ready_pre_enc, floo_wide_ready_pre_enc;
  logic floo_req_valid_pre_enc, floo_rsp_valid_pre_enc, floo_wide_valid_pre_enc;
  floo_req_chan_t floo_req_req_pre_enc;
  floo_rsp_chan_t floo_rsp_rsp_pre_enc;
  floo_wide_chan_t floo_wide_wide_pre_enc;

  logic floo_req_ready_after_dec, floo_rsp_ready_after_dec, floo_wide_ready_after_dec;
  logic floo_req_valid_after_dec, floo_rsp_valid_after_dec, floo_wide_valid_after_dec;
  floo_req_chan_t floo_req_req_after_dec;
  floo_rsp_chan_t floo_rsp_rsp_after_dec;
  floo_wide_chan_t floo_wide_wide_after_dec;
  ...
  if (ChimneyCfgN.CutRsp && ChimneyCfgW.CutRsp) begin : gen_rsp_cuts
    spill_register #(
      ...
      .clk_i,
      .rst_ni,
      .data_i     ( floo_req_req_after_dec      ),
      .valid_i    ( floo_req_valid_after_dec    ),
      .ready_o    ( floo_req_ready_pre_enc    ),
      .data_o     ( floo_req_in         ),
    ...
    spill_register #(
      ...
      .clk_i,
      .rst_ni,
      .data_i     ( floo_rsp_rsp_after_dec      ),
      .valid_i    ( floo_rsp_valid_after_dec    ),
      .ready_o    ( floo_rsp_ready_pre_enc    ),
      .data_o     ( floo_rsp_in         ),
    ...
    spill_register #(
      ...
      .clk_i,
      .rst_ni,
      .data_i     ( floo_wide_wide_after_dec    ),
      .valid_i    ( floo_wide_valid_after_dec   ),
      .ready_o    ( floo_wide_ready_pre_enc   ),
      .data_o     ( floo_wide_in        ),
    ...
    assign floo_req_in = floo_req_req_after_dec;
    assign floo_rsp_in = floo_rsp_rsp_after_dec;
    assign floo_wide_in = floo_wide_wide_after_dec;
    assign floo_req_in_valid = floo_req_valid_after_dec;
    assign floo_rsp_in_valid = floo_rsp_valid_after_dec;
    assign floo_wide_in_valid = floo_wide_valid_after_dec;
    assign floo_req_ready_pre_enc = floo_req_out_ready;
    assign floo_rsp_ready_pre_enc = floo_rsp_out_ready;
    assign floo_wide_ready_pre_enc = floo_wide_out_ready;
  end
  ...
  floo_wormhole_arbiter #(
    ...
    .data_o   ( floo_req_req_pre_enc        ),
    .ready_i  ( floo_req_ready_after_dec     ),
    .valid_o  ( floo_req_valid_pre_enc      )
  );
  ...
  floo_wormhole_arbiter #(
    ...
    .data_o   ( floo_rsp_rsp_pre_enc        ),
    .ready_i  ( floo_rsp_ready_after_dec      ),
    .valid_o  ( floo_rsp_valid_pre_enc      )
  );
  ...
  floo_wormhole_arbiter #(
    ...
    .data_o   ( floo_wide_wide_pre_enc      ),
    .ready_i  ( floo_wide_ready_after_dec     ),
    .valid_o  ( floo_wide_valid_pre_enc     )
  );
  ...
  relfloo_encoder #(
    ...
    .valid_i    ( floo_req_valid_pre_enc ),
    .ready_i    ( floo_req_ready_pre_enc ),
    .chan_i     ( floo_req_req_pre_enc   ),
    .valid_o    ( floo_req_o.valid       ),
    .ready_o    ( floo_req_o.ready       ),
    .chan_o     ( floo_req_o.req         )
  );
  ...
  relfloo_encoder #(
    ...
    .valid_i    ( floo_rsp_valid_pre_enc ),
    .ready_i    ( floo_rsp_ready_pre_enc ),
    .chan_i     ( floo_rsp_rsp_pre_enc   ),
  ...
  relfloo_encoder #(
    ...
    .valid_i    ( floo_wide_valid_pre_enc  ),
    .ready_i    ( floo_wide_ready_pre_enc  ),
    .chan_i     ( floo_wide_wide_pre_enc   ),
    .valid_o    ( floo_wide_o.valid        ),
    .ready_o    ( floo_wide_o.ready        ),
    .chan_o     ( floo_wide_o.wide         )
  );
  ...
  `ASSERT(NarrowReqOutStableValid, floo_req_valid_pre_enc &&
                                   !floo_req_ready_after_dec |=> floo_req_valid_pre_enc)
  `ASSERT(NarrowReqInStableValid, floo_req_valid_after_dec &&
                                  !floo_req_ready_pre_enc|=> floo_req_valid_after_dec)
  `ASSERT(NarrowRspOutStableValid, floo_rsp_valid_pre_enc &&
                                   !floo_rsp_ready_after_dec |=> floo_rsp_valid_pre_enc)
  `ASSERT(NarrowRspInStableValid, floo_rsp_valid_after_dec &&
                                  !floo_rsp_ready_pre_enc |=> floo_rsp_valid_after_dec)
  `ASSERT(WideOutStableValid, floo_wide_valid_pre_enc &&
                              !floo_wide_ready_after_dec |=> floo_wide_valid_pre_enc)
  `ASSERT(WideStableValid, floo_wide_valid_after_dec &&
                           !floo_wide_ready_pre_enc |=> floo_wide_valid_after_dec)

...
module tb_relfloo_nw_chimney;
  ...
  `FLOO_TYPEDEF_NW_AXI_TYPES(axi_narrow, axi_wide, floo_test_pkg::AxiCfgN, floo_test_pkg::AxiCfgW)
  `FLOO_TYPEDEF_REL_NW_CHAN_ALL(axi, req, rsp, wide, axi_narrow_in, axi_wide_in,
      floo_test_pkg::AxiCfgN, floo_test_pkg::AxiCfgW, hdr_t)
  `FLOO_TYPEDEF_REL_NW_LINK_ALL(req, rsp, wide, req, rsp, wide)
  ...
  relfloo_req_t [NumTargets-1:0] chimney_req;
  relfloo_rsp_t [NumTargets-1:0] chimney_rsp;
  relfloo_wide_t [NumTargets-1:0] chimney_wide;

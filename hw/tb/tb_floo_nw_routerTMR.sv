...
module tb_floo_nw_routerTMR;
  ...
  floo_req_t [Eject:North] floo_req_DUT_inA, floo_req_DUT_inB, floo_req_DUT_inC;
  floo_req_t [Eject:North] floo_req_DUT_outA, floo_req_DUT_outB, floo_req_DUT_outC;
  floo_rsp_t [Eject:North] floo_rsp_DUT_inA, floo_rsp_DUT_inB, floo_rsp_DUT_inC;
  floo_rsp_t [Eject:North] floo_rsp_DUT_outA, floo_rsp_DUT_outB, floo_rsp_DUT_outC;
  floo_wide_t [Eject:North] floo_wide_DUT_inA, floo_wide_DUT_inB, floo_wide_DUT_inC;
  floo_wide_t [Eject:North] floo_wide_DUT_outA, floo_wide_DUT_outB, floo_wide_DUT_outC;

  assign floo_req_DUT_inA  = floo_req_in[1][1];
  assign floo_req_DUT_inB  = floo_req_in[1][1];
  assign floo_req_DUT_inC  = floo_req_in[1][1];
  assign floo_req_out[1][1] = (floo_req_DUT_outA & floo_req_DUT_outB) |
                              (floo_req_DUT_outB & floo_req_DUT_outC) |
                              (floo_req_DUT_outA & floo_req_DUT_outC);
  assign floo_rsp_DUT_inA  = floo_rsp_in[1][1];
  assign floo_rsp_DUT_inB  = floo_rsp_in[1][1];
  assign floo_rsp_DUT_inC  = floo_rsp_in[1][1];
  assign floo_rsp_out[1][1] = (floo_rsp_DUT_outA & floo_rsp_DUT_outB) |
                              (floo_rsp_DUT_outB & floo_rsp_DUT_outC) |
                              (floo_rsp_DUT_outA & floo_rsp_DUT_outC);
  assign floo_wide_DUT_inA  = floo_wide_in[1][1];
  assign floo_wide_DUT_inB  = floo_wide_in[1][1];
  assign floo_wide_DUT_inC  = floo_wide_in[1][1];
  assign floo_wide_out[1][1] = (floo_wide_DUT_outA & floo_wide_DUT_outB) |
                               (floo_wide_DUT_outB & floo_wide_DUT_outC) |
                               (floo_wide_DUT_outA & floo_wide_DUT_outC); 
  ...
  floo_nw_routerTMR_dut_wrapper #(
    ...
    .floo_req_iA     ( floo_req_DUT_inA   ),
    .floo_req_iB     ( floo_req_DUT_inB   ),
    .floo_req_iC     ( floo_req_DUT_inC   ),
    .floo_rsp_iA     ( floo_rsp_DUT_inA   ),
    .floo_rsp_iB     ( floo_rsp_DUT_inB   ),
    .floo_rsp_iC     ( floo_rsp_DUT_inC   ),
    .floo_req_oA     ( floo_req_DUT_outA  ),
    .floo_req_oB     ( floo_req_DUT_outB  ),
    .floo_req_oC     ( floo_req_DUT_outC  ),
    .floo_rsp_oA     ( floo_rsp_DUT_outA  ),
    .floo_rsp_oB     ( floo_rsp_DUT_outB  ),
    .floo_rsp_oC     ( floo_rsp_DUT_outC  ),
    .floo_wide_iA     ( floo_wide_DUT_inA  ),
    .floo_wide_iB     ( floo_wide_DUT_inB  ),
    .floo_wide_iC     ( floo_wide_DUT_inC  ),
    .floo_wide_oA     ( floo_wide_DUT_outA ),
    .floo_wide_oB     ( floo_wide_DUT_outB ),
    .floo_wide_oC     ( floo_wide_DUT_outC ),

...
module relfloo_axi_chimney #(
  ...
  `FLOO_TYPEDEF_REL_AXI_CHAN_ALL(axi, req, rsp, axi, AxiCfg, hdr_t)
  ...
  logic floo_req_ready_pre_enc, floo_rsp_ready_pre_enc;
  logic floo_req_valid_pre_enc, floo_rsp_valid_pre_enc;
  floo_req_chan_t floo_req_req_pre_enc;
  floo_rsp_chan_t floo_rsp_rsp_pre_enc;

  logic floo_req_ready_after_dec, floo_rsp_ready_after_dec;
  logic floo_req_valid_after_dec, floo_rsp_valid_after_dec;
